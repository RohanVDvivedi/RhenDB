...
PUBLIC_HEADERS:=${PROJECT_NAME}.h rage_engine.h transaction_table.h transaction_status.h mvcc_snapshot.h mvcc_header.h
...
LFLAGS:=-L${LIB_DIR} -l${PROJECT_NAME} -ltuplestore -lcutlery
# Archiver
AR:=ar rcs
