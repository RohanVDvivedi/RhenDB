...
int main(int argc, char** argv)
{
	...
	printf("Building pipeline :\n");
	{
		...
		setup_hash_semi_join_operator(join_operator, left_input_operator, LEFT_KEY_POS, right_input_operator, RIGHT_KEY_POS, RECORD_S_KEY_ELEMENT_COUNT, LEFT_SEMI_JOIN, PARTITIONS_COUNT, BUCKETS_PER_PARTITION, PARALLEL_HASH_JOIN_JOBS_COUNT, PARALLEL_HASH_JOIN_JOBS_QUEUE_SIZE, MIN_BUFFER_SIZE);
